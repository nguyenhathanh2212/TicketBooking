...
return [
    ...
    */
    ...
    'lt' => [
        ...
        'array' => 'Trường :attribute phải nhỏ hơn :value phần tử.',
    ],
    'lte' => [
        'numeric' => 'The :attribute phải nhỏ hơn hoặc bằng :value.',
        'file' => 'The :attribute phải nhỏ hơn hoặc bằng :value kilobytes.',
        'string' => 'The :attribute phải nhỏ hơn hoặc bằng :value kí tự.',
        'array' => 'The :attribute không được có nhiều hơn :value phần tử.',
    ],
    'max' => [
    ...
    'starts_with' => 'Trường :attribute phải bắt đầu với: :values',
    ...
    'uuid' => 'Trường :attribute không phải phải có định dạng UUID hợp lệ.',
